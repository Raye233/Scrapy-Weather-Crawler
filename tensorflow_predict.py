...
class WeatherPredictor:
    def __init__(self):
        # 加载所有组件
        self.model = load_model('tensorflow_model/weather_model.h5')
        self.scaler_X = joblib.load('tensorflow_model/scaler_X.save')
        self.scaler_y = joblib.load('tensorflow_model/scaler_y.save')
        self.wind_dir_encoder = joblib.load('tensorflow_model/wind_dir_encoder.save')
        self.uv_encoder = joblib.load('tensorflow_model/uv_encoder.save')
