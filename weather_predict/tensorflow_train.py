...
model.save('weather_model.h5')  # HDF5格式

# 保存预处理相关对象
joblib.dump(scaler_X, '../tensorflow_model/scaler_X.save')
joblib.dump(scaler_y, '../tensorflow_model/scaler_y.save')
joblib.dump(wind_dir_encoder, '../tensorflow_model/wind_dir_encoder.save')
joblib.dump(uv_encoder, '../tensorflow_model/uv_encoder.save')
