...
class TrainingThread(QThread):
    ...
    def __init__(self, file_path, use_pytorch=False):
        super().__init__()
    ...
    def run(self):
        try:
            ...
            if self.use_pytorch:
                train_script = 'pytorch_train_api.py'
            else:
                train_script = 'tensorflow_train_api.py'
            print(f"当前使用{train_script}")
            # 打开一个管道来捕获输出
...
class TrainWidgets(SiPage):
    ...
    def start_model_training(self):
        ...
        self.training_thread.use_pytorch = self.select_pytorch.isChecked()
